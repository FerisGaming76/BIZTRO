...
function read(a)
{
    var html="www.minitik.xyz";
    document.getElementById("result").innerHTML=html;
    if(a.indexOf("http://") === 0 || a.indexOf("https://") === 0){
	    location.href = a + '&e=1';
    } else {
        location.href = 'https://minitik.xyz/index.php?' + a + '&e=1';
    }
}	
...
function load()
{
	...
	{
		document.getElementById("mainbody").style.display="inline";
		document.getElementById("mainbody").innerHTML='<p id="mp1">QR code scanner by www.minitik.xyz</p><br>'+
